...
const Footer = () => {
  return (
    <div className='sm:px-[100px] px-[16px] bg-white pt-[20px]'>
      <h5 className="font-normal sm:text-start text-center">
        Holmes education group
      </h5>
      <div className="flex flex-col mt-[30px] mb-[80px] text-[#737373] items-center sm:items-start">
      ...
      <div className="flex sm:flex-row flex-col items-center gap-[16px] sm:gap-[50px]">
